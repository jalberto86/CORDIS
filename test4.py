# This program inputs 4 files from a CORDIS search, the "project.json" and the "organization.json" from 2 different
# searches. It processes them into a .csv that contains in each row the total ammount of the project, and the
